import {jsxs,jsx}from'react/jsx-runtime';var i={"aria-busy":true,role:"progressbar"};var m=({visible:a=true,width:s="80",height:c="80",wrapperClass:n="",wrapperStyle:o={},ariaLabel:p="hourglass-loading",colors:e=["#306cce","#72a1ed"]})=>a?jsxs("svg",{width:s,height:c,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 350 350",preserveAspectRatio:"xMidYMid",className:n,style:o,"aria-label":p,"data-testid":"hourglass-svg",...i,children:[jsx("animateTransform",{attributeName:"transform",type:"rotate",values:"0; 0; -30; 360; 360",keyTimes:"0; 0.40; 0.55; 0.65; 1",dur:"3s",begin:"0s",calcMode:"linear",repeatCount:"indefinite"}),jsxs("g",{children:[jsx("path",{fill:e[0],stroke:e[0],d:`M324.658,20.572v-2.938C324.658,7.935,316.724,0,307.025,0H40.313c-9.699,0-17.635,7.935-17.635,17.634v2.938
				...
				c-3.637,0-4.506,2.102-1.932,4.67L168.986,156.219z`}),jsx("animate",{attributeName:"opacity",values:"1; 1; 0; 0; 1; 1",keyTimes:"0; 0.1; 0.4; 0.65; 0.66; 1",dur:"3s",repeatCount:"indefinite"})]})]})]}):null;export{m as Hourglass};//# sourceMappingURL=hourglass.mjs.map
